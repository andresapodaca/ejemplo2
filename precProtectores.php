...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container-fluid">
        <div class="navbar-header ">
            ...
            <a class="navbar-brand" href="precProtectores.php">Papeleria Multiservicios Escolares</a>
        </div>
        <div class="collapse navbar-collapse" id="myNavbar">
            ...
            <ul class="nav navbar-nav navbar-right">
               <li><a href="registroProtectores.html"><span class="glyphicon glyphicon-barcode"></span> Agregar producto</a>
            ...
            <table class="table table-hover">
                <thead>
                    <tr class="filters">
                        ...
                        <th>
                            <input type="text" class="form-control" placeholder="Existencia" disabled>
                        </th>
                        <th>
